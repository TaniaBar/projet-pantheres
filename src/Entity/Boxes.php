...
#[ORM\Entity(repositoryClass: BoxesRepository::class)]
class Boxes
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Images::class, mappedBy: 'boxes')]
